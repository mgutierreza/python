...
class objetoResponse(iObjetoAplicacion):
    ...
    def __generarCuerpoClase(self):
        ...
        cuerpoClase += self.TAB + "public class " + self.__nombreClase + " : ItemResponse<bool>" + self.ENTER
        cuerpoClase += self.TAB + "{" + 2*self.ENTER 
        cuerpoClase += self.TAB + "}" + 2*self.ENTER
        
        cuerpoClase += self.TAB + "public class " + self.__nombreTabla + "ItemResponse : ItemResponse<" + self.__nombreTabla + "Entity>" + self.ENTER
        cuerpoClase += self.TAB + "{" + 2*self.ENTER 
        cuerpoClase += self.TAB + "}" + 2*self.ENTER

        cuerpoClase += self.TAB + "public class " + self.__nombreTabla + "LstItemResponse : LstItemResponse<" + self.__nombreTabla + "Entity>" + self.ENTER
        cuerpoClase += self.TAB + "{" + 2*self.ENTER 
        cuerpoClase += self.TAB + "}" + 2*self.ENTER
